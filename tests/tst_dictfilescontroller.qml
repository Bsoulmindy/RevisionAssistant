...
TestCase {
    ...
    DictFilesController {
        id: dictFilesController_MToM_basic
    ...
    function cleanup() {
        ...
        if(dictFilesController_MToM_basic.selected_file === "test_basic_dict1.json") {
            dictFilesController_MToM_basic.rename_database_file("test_basic_MToM_dict");
        }

        dictFilesController_MToM_basic.select_file("test_basic_MToM_dict.json");
        dictFilesController_MToM_basic.use_database_file("test_basic_MToM_dict.json");
        dictFilesController_MToM_basic.mark_default_database_file("test_basic_MToM_dict.json");
        dictFilesController_MToM_basic.error.connect((msg) => {
            // reset
        });
    }
    ...
    function test_get_file_name_without_extension(data) {
        ...
        compare(dictFilesController_MToM_basic.get_file_name_without_extension(data.input), data.output, data.tag);
    }
    ...
    function test_select_file_from_list() {
        ...
        files = dictFilesController_MToM_basic.files;
        verify(files.length >= 3, "Should detect the empty, basic and large dicts");
        dictFilesController_MToM_basic.select_file("test_large_MToM_dict.json");
        verify(dictFilesController_MToM_basic.selected_file === "test_large_MToM_dict.json", "Should select the large dict");
    }
    ...
    // ManyToMany
    function test_create_and_remove_dict_MToM() {
        dictFilesController_MToM_basic.add_new_empty_file("test_dictfilescontroller", 0);
        verify(dictFilesController_MToM_basic.files.length >= 4, "Should detect the 3 autocreated dicts + the new created dict");
        dictFilesController_MToM_basic.use_database_file("test_dictfilescontroller.json");
        compare(dictFilesController_MToM_basic.current_file, "test_dictfilescontroller.json", "Should used the new created dict");
        ...
        dictFilesController_MToM_basic.remove_database_file("test_dictfilescontroller.json")
        compare(isErrorThrown, true, "The files controller should not remove a dict that is being used");

        // Returning back to basic dict
        dictFilesController_MToM_basic.use_database_file("test_basic_MToM_dict.json");
        compare(dictFilesController_MToM_basic.current_file, "test_basic_MToM_dict.json", "Should used bach the basic dict");

        // Make the newly created dict default, and try to delete the default dict
        dictFilesController_MToM_basic.mark_default_database_file("test_dictfilescontroller.json");
        compare(dictFilesController_MToM_basic.default_file, "test_dictfilescontroller.json", "The default dict should have been changed!");
        isErrorThrown = false;
        dictFilesController_MToM_basic.remove_database_file("test_dictfilescontroller.json")
        compare(isErrorThrown, true, "The files controller should not remove a default dict");
        ...
        // Make basic dict default again
        dictFilesController_MToM_basic.mark_default_database_file("test_basic_MToM_dict.json");
        compare(dictFilesController_MToM_basic.default_file, "test_basic_MToM_dict.json", "The default dict should have been changed!");

        // Delete the created dict
        dictFilesController_MToM_basic.remove_database_file("test_dictfilescontroller.json")
        verify(dictFilesController_MToM_basic.files.length >= 3, "Should detect the 3 autocreated dicts");
    }
    ...
    function test_rename_dict() {
        ...
        dictFilesController_MToM_basic.select_file("test_basic_MToM_dict.json");
        dictFilesController_MToM_basic.rename_database_file("test_basic_MToM_dict1");
        compare(dictFilesController_MToM_basic.selected_file, "test_basic_MToM_dict1.json", "The selected file name should also be renamed");
        compare(dictFilesController_MToM_basic.default_file, "test_basic_MToM_dict1.json", "The selected file name should also be renamed");
        compare(dictFilesController_MToM_basic.current_file, "test_basic_MToM_dict1.json", "The selected file name should also be renamed");
    }
    ...
    function test_export_and_import() {
        ...
        dictFilesController_basic.import_database_file(true, "mock.json");
        ...
        dictFilesController_MToM_basic.select_file("test_basic_MToM_dict.json");
        originalLen = dictFilesController_MToM_basic.dict_controller.num_rows;

        dictFilesController_MToM_basic.export_database_file(true);
        verify(fileSystemUtils.is_file_exist_from_standard("test_basic_MToM_dict.json.export"), "The export file is not found");

        dictFilesController_MToM_basic.import_database_file(true, "mock2.json");
        verify(fileSystemUtils.is_file_exist_from_standard("mock2.json"), "The imported file is not found");
        dictFilesController_MToM_basic.use_database_file("mock2.json");
        compare(originalLen, dictFilesController_MToM_basic.dict_controller.num_rows, "The imported file doesn't look the same before export");
    }
}
